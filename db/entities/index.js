...
import { TruckEntity, DriverEntity, TruckEMIEntity, MaintenanceExpenseEntity, FuelSiteEntity, FuelTransactionEntity, } from "./fleet.entities";
import { ClientEntity, SiteEntity, RouteEntity, BrokerEntity, ItemProductEntity, OrderEntity, ExpenseEntity, } from "./operations.entities";
import { BankEntity, InvoiceEntity, PlantAdvanceEntity, PlantAdvancePoolEntryEntity, StationRateEntity, BankTransactionEntity, PaymentRecordEntity, } from "./finance.entities";
import { EmployeeEntity, DriverSalaryEntity, EmployeeSalaryEntity, AttendanceRecordEntity, LeaveRequestEntity, PerformanceMetricEntity, } from "./hr.entities";
