...
import { TruckEntity, DriverEntity, ClientEntity, SiteEntity, RouteEntity, BrokerEntity, EmployeeEntity, BankEntity, ItemProductEntity, ExpenseEntity, TruckEMIEntity, MaintenanceExpenseEntity, CustomAlertEntity, PlantAdvanceEntity, StationRateEntity, FuelSiteEntity, FuelTransactionEntity, BankTransactionEntity, PaymentRecordEntity, AttendanceRecordEntity, LeaveRequestEntity, PerformanceMetricEntity, } from "../../db/entities";
/**
...
export function registerCrudRoutes(mount) {
